...
class Slave2Card extends React.Component{
                    ...
                    <div className="flip-card shadow bg-transparent">
                        ...
                        <div className="flip-card-inner">
                            ...
                            <div className="flip-card-back">
                                <h5 style={{paddingTop:"10px", paddingBottom:"0px"}}>Slave 2: {this.state.status}</h5>
    ...
    fetchUpdate = () => {
        ...
        fetch(`${API_URL}/api/liveip`)
            ...
            .then( response => {
                this.setState({ip : response[2].ipv6});
