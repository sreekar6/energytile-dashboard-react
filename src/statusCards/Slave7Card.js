...
class Slave7Card extends React.Component{
            ...
            <div style={{margin: '10px'}}>
                {
                    ...
                    <div className="card shadow bg-success rounded">
                        ...
                        <div className="card-img-overlay ">
                            <h5 className="card-title" style={{color: '#ccc'}}>Slave 7</h5>
                ...
                }
                {
                    ...
                    <div className="card shadow bg-danger rounded">
                        ...
                        <div className="card-img-overlay">
                            <h5 className="card-title">Slave 7</h5>
    ...
    fetchUpdate = () => {
        ...
        fetch('https://energytile-dashboard.herokuapp.com/api/liveip')
            ...
            .then( response => {
                this.setState({ip : response[7].ipv6});
                if(response[7].live === 1){
                    fetch('https://energytile-dashboard.herokuapp.com/api/slave7')
                        .then(response => response.json())
                        .then(response => {
