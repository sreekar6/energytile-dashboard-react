...
class Slave6Card extends React.Component{
    ...
    componentDidMount() {
        this.fetchUpdate();
        setInterval(this.fetchUpdate,1000)
    }
                    ...
                    <div className="flip-card shadow bg-transparent">
                        ...
                        <div className="flip-card-inner">
                            ...
                            <div className="flip-card-back">
                                <h5 style={{paddingTop:"10px", paddingBottom:"0px"}}>Slave 6: {this.state.status}</h5>
    ...
    fetchUpdate = () => {
        ...
        fetch(`${API_URL}/api/liveip`)
            ...
            .then( response => {
                this.setState({ip : response[6].ipv6});
